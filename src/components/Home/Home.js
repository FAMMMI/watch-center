...
const Home = () => {
    ...
    return (
        <div className='px-4 pt-10 pb-10 mx-auto max-w-7xl md:px-2'>
            <div className='h-full grid grid-cols-1 md:grid-cols-2 justify-items-center gap-4 md:justify-items-around md:content-center'>
                <div className='md:order-1 order-2'>
                    <p className='text-blue-400 text-5xl font-bold '>Welcome to Watch Center</p> <br />
            ...
            <div className='mt-6  '>
                <button onClick={handleShowAll} className='rounded-md bg-slate-200 border-slate-400 border-2 text-lg font-semibold p-2  text-black hover:bg-slate-500 hover:text-blue-100' >See All Reviews</button>
            </div>
        </div>
    );
};
